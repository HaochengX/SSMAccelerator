...
//   [ Z: C2 ] [ XBC: C_CONV ] [ DT: CH ]
//   B and C are derived from conv1d output on the XBC bundle.
//   XBC = [ B: N ] [ C: N ] [ x: C2 ] = N + N + C2 = C_CONV = 5376
//   (B/C at front matches LightMamba SILU_DEMUX ordering)
// =============================================================
#ifndef SSMU_C_IN
...
// =============================================================
// ★ LOW-RANK dimension (matches ssm_lowrank_v2.cpp SSMU_RANK=1024)
// =============================================================
#ifndef SSMU_RANK
...
#ifndef SSMU_RANK_T
#define SSMU_RANK_T (SSMU_RANK / SSMU_CP)            // 128
#endif
...
// =============================================================
// TOP prototype — v2 LOW-RANK signature (matches ssm_lowrank_v2.cpp)
//   ★ v2 changes from original:
//     W_inproj  → W_in_1[D_T][RANK_T] × W_in_2[RANK_T][CIN_T]
//     W_out     → W_out_A[D_T][RANK_T] × W_out_B[RANK_T][C2_T]
//     RMS_weight_2 added (second RMSNorm between stage6 and out_proj)
//   ✅ A_fixed is STATE_T (vectorized state tokens)
// =============================================================
void SSMU(
    ...
    const DTYPE_VEC  RMS_weight_2[SSMU_C2_T],      // ★ v2: second RMSNorm

    // ★ v2 LOW-RANK: W_inproj factored into two matrices
    const W_VEC      W_in_1[SSMU_D_T][SSMU_RANK_T],
    const W_VEC      W_in_2[SSMU_RANK_T][SSMU_CIN_T],

    const W_VEC      W_delta[SSMU_C2_T][SSMU_C2_T],

    // ★ v2 LOW-RANK: W_out factored into two matrices
...
#endif // __UCI_EECS_S6666SMU_HEADER_LAYERSH_ALIGNED__
