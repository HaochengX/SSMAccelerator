...
// ============================================================
#ifndef TB_BUILD_TAG
#define TB_BUILD_TAG "tb_ssmu.cpp UPDATED_FOR_SSMU_NO_WBC + WSCALE_LOAD(PRESENCE) + COSIM_TOP_CALL_SSMU_STACK64 + CS_COMPARE + H1_DDR_FALLBACK + INTERLEAVE TAG_2026-02-24_v2"
#endif
...
// ============================================================
// ✅ COSIM symbol fix: ensure SSMU_STACK64 is visible even if header doesn't declare it
// ============================================================
...
int main() {
    ...
    if (!load_w_mat<D_T, CIN_T>(P0("W_inproj_f32.raw.bin"), W_inproj, "W_inproj")) return 1;
    if (!load_w_mat<C2_T, C2_T>(P0("W_delta_f32.raw.bin"),  W_delta,  "W_delta")) return 1;
    if (!load_w_mat<D_T, C2_T>(P0("W_out_f32.raw.bin"),     W_out,    "W_out")) return 1;
