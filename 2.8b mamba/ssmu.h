...
// DO NOT define macros N/DIM/K.
// Provide SAFE C++ constants instead (so old code using N/DIM/K compiles).
// =============================================================
...
static_assert((SSMU_DIM_C % SSMU_VEC_FACTOR_C) == 0, "SSMU_DIM must be divisible by SSMU_VEC_FACTOR");
